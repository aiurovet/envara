...
- ensure tests will produce the same results when run on different platforms by:
  - mocking os.sep
  - mocking EnvChars.IS_POSIX, EnvChars.IS_VMS and EnvChars.IS_WINDOWS
  - mocking Env.IS_POSIX, Env.IS_VMS and Env.IS_WINDOWS
  - passing Env.POSIX, Env.VMS and Env.WINDOWS as parameter chars where applicable
