...
def main():
    ...
    # Make expansions portable between POSIX and Windows
...
- `Env.break_args(list, ...)` — split arguments into proper (app) args and towed (other) args (like pipes, I/O redirections and logical operators), with a piping indicator.
